		...
		<div className="bg-white">
				...
				<div className="absolute inset-0 flex items-center justify-center text-white">
					<div className="text-center">
						...
						<p className="text-lg mt-4">
							Together, we are building a stronger, more connected
							community.
						</p>
					</div>
				</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
						<div className="bg-teal-50 rounded-lg shadow-md p-6">
							<p className="text-gray-700">
								Food Connect has helped us bridge the gap
								between surplus and scarcity. It is amazing!
							</p>
							<div className="flex items-center mt-4">
								...
								/>
								<div className="ml-4">
									<h4 className="text-teal-700 font-bold">
										Emily Watson
									</h4>
						...
						<div className="bg-teal-50 rounded-lg shadow-md p-6">
							<p className="text-gray-700">
								As a single mother, the support I have received
								from Food Connect has been a lifesaver. Forever
								grateful!
							</p>
							<div className="flex items-center mt-4">
								<img
						...
						<div className="bg-teal-50 rounded-lg shadow-md p-6">
							<p className="text-gray-700">
								We have been able to provide meals to families
								in need. This platform is a blessing!
							</p>
							<div className="flex items-center mt-4">
								<img
						...
						<div className="bg-teal-50 rounded-lg shadow-md p-6">
							<p className="text-gray-700">
								The impact Food Connect has made is
								immeasurable. Truly life-changing.
							</p>
							<div className="flex items-center mt-4">
								<img
			...
			<div className="py-16 bg-teal-800">
				<div className="max-w-screen-xl mx-auto text-center text-white">
					...
					<p className="text-lg mt-4">
						Whether you donate food or time, every contribution
						counts. Be a part of the change.
					</p>
					<div className="gap-4 mt-10">
						...
						<Link
							to="/"
							className=" bg-teal-600 text-white rounded-lg text-lg font-bold px-6 py-3 shadow-md hover:bg-teal-600 hover:shadow-lg"
						>
							Back to Home
						</Link>
					</div>
