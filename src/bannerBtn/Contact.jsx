  ...
  return (
    <div className="py-16 px-4 bg-teal-100">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-extrabold font-serif text-teal-700">
          Contact Us
        </h1>
        <p className="text-gray-600 mt-4 text-lg">
          We are here to help! Reach out with your food donation or order
          queries.
        </p>
      </div>
      ...
      <div className="max-w-3xl mx-auto mt-8 bg-white rounded-xl shadow-lg p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="px-8 py-3 bg-teal-600 text-white rounded-lg shadow-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-400"
            >
              Submit
            </button>
          </div>
