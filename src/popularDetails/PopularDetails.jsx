...
const PopularDetails = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Title */}
      <h2 className="text-4xl font-bold text-teal-700 font-serif mb-6 text-center">
        ~Food Details~
      </h2>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center ">
              <button
                ...
                className="py-2 px-4 bg-teal-600 text-white font-bold rounded-lg hover:bg-teal-700 w-full  md:w-1/2"
              >
                Request Food
              </button>
              <Link
                to="/"
                className="bg-teal-600 text-white px-4 py-2 rounded-lg w-full md:w-1/2 font-bold shadow-md hover:bg-teal-700 hover:shadow-lg text-center"
              >
                🏠 Back to Home
              </Link>
            </div>
      ...
      >
        <h3 className="text-2xl font-serif font-extrabold text-center mb-4 text-teal-700">
          Request Food
        </h3>
