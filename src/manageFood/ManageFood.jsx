	...
	return (
		<div className="container mx-auto px-4 py-8">
			...
			<div className="mb-6 text-center">
				<h2 className="text-head">Manage My Foods</h2>
			...
			>
				<h3 className="text-head">Edit Food</h3>
				{editingFood && (
					<form onSubmit={handleUpdate}>
						...
						<div className="flex gap-2">
							<button
								type="submit"
								className="w-full btn-teal-custom"
							>
								Save Changes
							</button>
							<button
								type="button"
								className="w-full btn-white-custom !bg-gray-200 hover:!bg-gray-300"
								onClick={() =>
									document
